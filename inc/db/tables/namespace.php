...
namespace Pressbooks\Lti\Provider\Db\Tables;
...
function install() {
	...
	global $wpdb;
	$current_version = get_site_option( \Pressbooks\Lti\Provider\Db\Tables\OPTION );
	$prefix = prefix();
	...
	update_site_option( \Pressbooks\Lti\Provider\Db\Tables\OPTION, \Pressbooks\Lti\Provider\Db\Tables\VERSION );
}
